...
namespace barn::ai_behaviors {
	using namespace std::chrono;

	struct ai_behavior_interface {
	...
	struct chaser : public ai_behavior_interface {
		std::chrono::nanoseconds static_cooldown() const override { return 0ms; }
		std::chrono::nanoseconds base_cooldown() const override { return 100ms; }
